...
void main (void)
{
    ...
    while(true)
    {
        ...
        for(j = 0; j<MAXPOINT; j++)
        {
            ...
            {
                /*Descomentar esto si se quiere apreciar mas a fondo el funcionamento ejecutando el program*/

                setcolor(BLUE);
                line(Punto0.x,Punto0.y,PuntoF.x,PuntoF.y); /*Esta linea se pinta solo para que se logre apreciar lo que se hace en cada interaccion*/
